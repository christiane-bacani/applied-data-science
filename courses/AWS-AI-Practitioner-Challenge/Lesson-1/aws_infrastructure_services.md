...
1. **Amazon SageMaker**: Fully managed machine learning service that you can use to build, train, and deploy your own custom models. It provides tools and infrastructure to accelerate your ML development and deployment lifecycle.
...
2. **Amazon Bedrock**: A fully managed service that makes Foundational Models from Amazon and other leading AI startups available through an API. Using this service to access FMs, experiment, customize it with our own data, efficiently integrate and deploy FMs into AWS Applications.